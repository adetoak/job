...
<div class="panel">
	...
	<!-- Nav tabs -->
	  	<ul class="nav nav-tabs" role="tablist">
	    	<li role="presentation" class="active"><a href="#newTab" aria-controls="newTab" role="tab" data-toggle="tab">Products</a></li>
		    <li role="presentation"><a href="#users" aria-controls="users" role="tab" data-toggle="tab">New Product</a></li>
		    <li role="presentation"><a href="#roles" aria-controls="users" role="tab" data-toggle="tab">Product Category</a></li> 
	  	</ul>
	  ...
	  <!-- Tab panes -->
	  	<div class="tab-content">
	    	...
	    	<div role="tabpanel" class="tab-pane" id="users">
		    	<form class="form-group" method="post" enctype="multipart/form-data" action="{{ url('newproduct') }}">
	    			{{ csrf_field() }}
	    ...
	    <div role="tabpanel" class="tab-pane clearfix" id="roles">
	    	<div class="">
	    		<form id="demo-form2" method="post" action="{{ url('productcategory') }}">
	    			{{ csrf_field() }}
